...
gopath(path){
    console.log('跳转')
    this.$router.push({name:path,params:{number:this.number}})
...
.select{
    color:  #69e0ff;
    border-top: 0.35rem solid #69e0ff !important;
}
.ZW{
     width: 30%;
}
